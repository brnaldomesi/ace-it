...
<head>
	...
	<title>ACE Heavy/Specialty</title>
	...
	<script language="JavaScript">
		function SubmitForm(oButton) {
			...
			if (bDoSubmit != false) {
				document.frmHeavySpecialty.submit();
			} else {
				oButton.disabled = 0;
			}
		}
...
'--------------------------------------------
  ...
  If Request.Querystring("txtState") <> "1" Then
    ...
    OfficeID = mUserInsCoOfficeID_HeavySpecialtyForm 'mUserACEInsCoOfficeID
  ...
  Else 
	...
	<p align="center"><b><font size="4"><font color="#008080">Click <a href="frmSubmitHeavySpecialtyReview.asp">Here</a> <font color="#008080">to Submit another claim.</font></font></b></p>
    ...
    With oUpload
     ...
     For Each oFile in .Files
	  ...
	  sBody = "<<< Heavy/Specialty Review Submission >>>" & VBCrLf & Now & VBCrLf & VBCrLf
  ...
  <form  method="POST" enctype="multipart/form-data" name="frmHeavySpecialty" action="FrmSubmitHeavySpecialtyReview.asp?txtState=1">
...
<table border="0" cellpadding="1" cellspacing="6">
  <tr>
    ...
    <b><i><font face="Times New Roman" size="4"><img border="0" src="../Images/ACELogo_icon.gif">&nbsp; Heavy/Specialty Submission Form</font></i></b></td>
  </tr>
    <tr>
    ...
    <tr>
      <td bgcolor="#FFFFCC" align="right" valign="top"><span id="Shop_Name_req_span">*Shop</span>
     </td>
