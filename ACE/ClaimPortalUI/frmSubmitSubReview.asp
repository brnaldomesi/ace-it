	...
	<script language="JavaScript">
		...
		function ValidateFrm() {
			...
			/*if (document.forms[0].AuditOnly.checked == true) {	//--- if Review Only
				...
				writeError("Adverse", true);
				writeError("Contact_Phone", true);
			} else {
			    writeError("Adverse", document.forms[0].Adverse_Business.value != "" || document.forms[0].Adverse_Person_First_Name.value != "" || document.forms[0].Adverse_Person_Last_Name.value != "");
			...
			/*
              ...
              if (document.forms[0].Adverse_Name.value == "") bAttachedFile = 2;
...
'--------------------------------------------
  ...
  If Request.Querystring("txtState") <> "1" Then
    ...
    OfficeID = mUserInsCoOfficeID_SubrogationForm 'mUserACEInsCoOfficeID
  ...
  Else
	...
	<p align="center"><b><font size="4"><font color="#008080">Click <a href="frmSubmitSubReview.asp">Here</a> <font color="#008080">to Submit another claim.</font></font></b></p>
    ...
    With oUpload
	  ...
	  sBody = "<<< SubReview Submission >>>" & VBCrLf & Now & VBCrLf & VBCrLf
  ...
  Sub SaveClaimSubmitToDbz()
    ...
    With oFormMailer
      .sHeader = "SubReview Claim Submission Form."
      .sFooter = ""
  ...
  <form  method="POST" enctype="multipart/form-data" name="frmSubReview" action="FrmSubmitSubReview.asp?txtState=1">
...
<table border="0" cellpadding="1" cellspacing="6">
  <tr>
    ...
    <b><i><font face="Times New Roman" size="4"><img border="0" src="../Images/ACELogo_icon.gif">&nbsp; SubReview Submission Form</font></i></b></td>
  </tr>
    <tr>
    ...
    <tr>
      ...
      <td><input type="text" name="Office_ID" style="width: 88%" value="<%=IIf(OfficeID = "A16S", "A16M", OfficeID)%>"></td>
    </tr>
    ...
    <tr>
        <td bgcolor="#FFFFCC" align="right" valign="top">&nbsp;Adverse (*if business)</td>
        <td><input type="text" name="Adverse_Business" style="width: 88%" placeholder="Business Name" ng-model="input.adverseBusiness" ng-disabled="!!input.adversePersonFirstName || !!input.adversePersonLastName"></td>
    </tr>
    <tr>
        <td bgcolor="#FFFFCC" align="right" valign="top">&nbsp;Adverse (*if person)</td>
        <td>
            <input type="text" name="Adverse_Person_First_Name" style="width: 43%;float: left;" placeholder="First Name" ng-model="input.adversePersonFirstName" ng-disabled="!!input.adverseBusiness">
            <input type="text" name="Adverse_Person_Last_Name" style="width: 43%;margin-left: 3px" placeholder="Last Name" ng-model="input.adversePersonLastName" ng-disabled="!!input.adverseBusiness">
        </td>
    </tr>
    <tr ID="Adverse_error_tr" style="display:none;">
    	<td>&nbsp;</td>
	    <td><SPAN STYLE=color:red ID="Adverse_error_span"></SPAN></td>
	</tr>
    <tr>
...
-->    
    ...
    <tr bgcolor="#ffe4b5">
     ...
     <font size="2" face="verdana,geneva,arial" color="#CC0000">Present Audit liability at</font></label></td>
    </tr>
    <tr bgcolor="#ffe4b5">
