...
'--------------------------------------------
  ...
  Else '<--- txtState = 1
	...
	<p align="center"><b><font size="4"><font color="#008080">Click <a href="frmSubmitAutoReviewWestfield.asp">Here</a> <font color="#008080">to Submit another claim.</font></font></b></p>
    ...
    With oUpload
     ...
     For Each oFile in .Files
	  ...
	  sBody = "<<< AutoReview Submission >>>" & VBCrLf & "<<< Custom Westfield Submission >>>" & VBCrLf & Now & VBCrLf & VBCrLf
  ...
  <form  method="POST" enctype="multipart/form-data" name="frmAutoReview" action="FrmSubmitAutoReviewWestfield.asp?txtState=1">
...
<table border="0" cellpadding="1" cellspacing="6">
  <tr>
    ...
    <tr>
      ...
      <td><input type="text" name="Feature_Number" maxlength="3" style="width: 88%"></td>
    </tr>
...
-->
	...
	<script>
        ...
        $(document).ready(function(){
            $('[name=Feature_Number]').keypress(validateNumber);
        });
