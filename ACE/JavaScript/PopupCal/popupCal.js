...
//******************************************************************************
    ...
    var scwDateOutputFormat  = 'MM/DD/YYYY'; //'DD-MMM-YYYY'; // e.g. 'MMM-DD-YYYY' for the US
...
// ****************************************************************************
    ...
    function scwShow(scwEle,scwSource)
        {if (!scwSource) {scwSource = window.event;}
         ...
         // changed 04/8/2008 B.P.
         var offsetTop =parseInt(scwTriggerEle.offsetTop ,10) - 20 //+ parseInt(scwEle.offsetHeight,10),
         var offsetLeft=parseInt(scwTriggerEle.offsetLeft,10) + parseInt(scwTriggerEle.offsetWidth,10);
...
//     "</iframe>" +
    document.write(
     "<iframe class='scw' " + (scwID('scwIElt7')?"":'') +
             "id='scwIframe' name='scwIframe' frameborder='0'>" +
     "</iframe>" +
